      ...
      <Card className="cursor-pointer hover:shadow-md transition-shadow">
        <CardContent className="p-3 sm:p-4">
          <div className="space-y-2 sm:space-y-3">
            ...
            {/* Meta data */}
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-1 sm:space-x-2 min-2-0">
                {task.assignee && (
  ...
  return (
    <>
      <div className="min-h-screen bg-gray-50">
        ...
        {/* Board Content*/}
        <main className="container mx-auto px-2 sm:p-4 py-4 sm:py-6">
          {/*Stats*/}
      ...
      <Dialog open={isEditingColumn} onOpenChange={setIsEditingColumn}>
        <DialogContent className="w-[95vw] max-w-[425px] mx-auto">
          <DialogHeader>
            <DialogTitle className="font-semibold">Edit Column</DialogTitle>
            <p className="text-sm text-gray-600">
              Updated the title of your column
            </p>
          </DialogHeader>
