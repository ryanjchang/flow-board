...
//https://eager-tiger-81.clerk.accounts.dev
...
export default function DashboardPage() {
  ...
  const boardsWithTaskCount = boards.map((board: Board) => ({
    ...board,
    taskCount: 0, //would need to calculate
  }));
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-6 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 space-y-4 sm:space-y-0">
            <div>
              <h2 className="text-xl sm: textl-2xl font-bold text-gray-900">
                Your Boards
              </h2>
      ...
      <Dialog open={isFilterOpen} onOpenChange={setIsFilterOpen}>
        <DialogContent className="w-[95vw] max-w-[425px] mx-auto">
          <DialogHeader>
            <DialogTitle className="font-semibold">Filter Boards</DialogTitle>
      ...
      <Dialog open={showUpgradeDialog} onOpenChange={setShowUpgradeDialog}>
        <DialogContent className="w-[95vw] max-w-[425px] mx-auto">
          <DialogHeader>
            ...
            <p className="text-sm text-gray-600">Free users can only create one board. Upgrade to Pro or Enterprise to create unlimited boards.</p>
          </DialogHeader>
